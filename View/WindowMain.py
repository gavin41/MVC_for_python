...
class Window(wx.Frame):
    def __init__(self, parent, 
        ...
        ## 按钮 & 编辑框
        self.B_Attack = wx.Button(self, -1, "Button")
        self.T_Target = wx.TextCtrl(self, -1, "Target URL", wx.DefaultPosition, wx.DefaultSize, 0)
        self.T_Output = wx.TextCtrl(self, -1, "This is TextCtrl.", wx.DefaultPosition, wx.DefaultSize, wx.TE_MULTILINE)
